...
class Overview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (overview == null || 
        overview["course_data"] == null || 
        overview["course_data"]["result"] == null ||
        overview["course_data"]["result"]["items"] == null) {
      // Return empty container for LifterLMS since this is LearnPress specific
      return Container();
    }
