          ...
          body: SingleChildScrollView(
              ...
              child: Stack(children: <Widget>[
                Positioned(
                  ...
                  child: IconButton(
                    onPressed: () {
                      // Simply go back, which should work in most cases
                      Get.back();
                    },
                ...
                Form(
                  // Remove form key - not needed with LifterLMS controller
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(mainAxisSize: MainAxisSize.min, children: [
                        Checkbox(
                          ...
                          value: value.agreeToTerms.value,
                          onChanged: (bool? newValue) {
                            //Do Something When Value Changes to True Or False
                            setState(() {
                              value.agreeToTerms.value = !value.agreeToTerms.value;
                            });
                          },
                        ),
                        SizedBox(
