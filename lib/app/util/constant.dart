...
class AppConstants {
  ...
  static const String registerFCMToken = 'wp-json/llms/v1/mobile-app/register-device';
  static const String deleteFCMToken = 'wp-json/llms/v1/mobile-app/delete-device';
  static const String enableSocialLogin = 'wp-json/llms/v1/mobile-app/enable-social';
  static const String verifyGGLogin = 'wp-json/llms/v1/mobile-app/verify-google';
  static const String verifyAppleLogin = 'wp-json/llms/v1/mobile-app/verify-apple';
  static const String verifyFBLogin = 'wp-json/llms/v1/mobile-app/verify-facebook';
  
  // Stripe Payment Endpoints
  static const String stripeCreatePaymentIntent = 'wp-json/llms/v1/mobile-app/stripe/create-payment-intent';
  static const String stripeConfirmPayment = 'wp-json/llms/v1/mobile-app/stripe/confirm-payment';
  static const String stripeGetPaymentMethods = 'wp-json/llms/v1/mobile-app/stripe/payment-methods';
  static const String stripeSetupIntent = 'wp-json/llms/v1/mobile-app/stripe/setup-intent';
